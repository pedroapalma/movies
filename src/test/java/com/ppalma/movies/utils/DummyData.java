package com.ppalma.movies.utils;
...
public interface DummyData {
  ...
  String MOVIES_PAGE_ENTITY_1 = "movies_paged_entity_1.json";

  String MOVIES_PAGE_ENTITY_2 = "movies_paged_entity_2.json";

  String MOVIES_PAGE_ENTITY_3 = "movies_paged_entity_3.json";
